...
import 'cloth_design_item.dart';


class ClothDesignCard extends StatelessWidget {
  List<DesignModel> designModels;
  ClothDesignCard({super.key,this.designModels = const []});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Column(
            children: List.generate(designModels.length, (index) => ClothDesignItem(designModel:designModels[index])),
          )
